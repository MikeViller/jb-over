...
// SMDKV210: For handling multiple SD cards and removable USB storage.
#define VOLUME_SDCARD                   "sdcard"
#define VOLUME_EXTSD                    "extsd"

#define MASS_STORAGE_FILE_PATH_SDCARD   "/sys/class/android_usb/android0/f_mass_storage/lun0/file"
#define MASS_STORAGE_FILE_PATH_EXTSD    "/sys/class/android_usb/android0/f_mass_storage/lun1/file"
#define MASS_STORAGE_FILE_PATH_MISC     "/sys/class/android_usb/android0/f_mass_storage/lun2/file"

inline const char *getVolumeLunPath(const char *label) {
    if (!strcmp(label, VOLUME_SDCARD))
        return MASS_STORAGE_FILE_PATH_SDCARD;
    else if (!strcmp(label, VOLUME_EXTSD))
        return MASS_STORAGE_FILE_PATH_EXTSD;
    else
        return MASS_STORAGE_FILE_PATH_MISC;
}
...
int VolumeManager::shareVolume(const char *label, const char *method) {
    ...
    if ((fd = open(getVolumeLunPath(v->getLabel()), O_WRONLY)) < 0) {
