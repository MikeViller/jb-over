...
public class Memory extends SettingsPreferenceFragment {
    ...
    private static class UsbOtgSwitchManager {
        private static final String usb_otg_switch_path = "/sys/devices/platform/mid-control/otg_switch";

        /* package */ static boolean get() {
            String data = null;
            ...
            try {
                fIn = new FileInputStream(usb_otg_switch_path);
        ...
        /* package */ static void set(boolean enable) {
            FileOutputStream fOut = null;
            OutputStreamWriter osw = null;

            try {
                fOut = new FileOutputStream(usb_otg_switch_path);
                osw = new OutputStreamWriter(fOut);
                osw.write(enable ? "1" : "0");
            } catch (Exception e) {
                e.printStackTrace(System.err);
            } finally {
                try {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        final MenuItem usb_otg_switch = menu.findItem(R.id.usb_otg_switch);
        usb_otg_switch.setChecked(UsbOtgSwitchManager.get());
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.storage_usb:
                ...
                return true;
            case R.id.usb_otg_switch:
                final boolean otg_switch = !item.isChecked();
                UsbOtgSwitchManager.set(otg_switch);
                item.setChecked(otg_switch);
                return true;
